...
router.get("/gallary",async function(req,res){
    ...
    var obj = {"tn":tn[0],"gallery":gallery}
...
router.post("/save_contact",async function(req,res){
    var d = req.body;
    var sql = `INSERT INTO contact(name,phone,email,subject,message )VALUES(?,?,?,?,?)`;
    var data = await exe (sql,[d.name,d.phone,d.email,d.subject,d.message]);
